  ...
  return (
    ...
    <TopBar />
      <div className="flex flex-col items-center space-y-6">
        ...
        {action ? (<Link href="/personalities" className="group relative inline-flex h-[calc(48px+8px)] items-center justify-center rounded-full bg-neutral-950 py-1 pl-6 pr-14 font-medium text-neutral-50">結果を確認する</Link>): (<div></div>)}
